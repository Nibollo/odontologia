...
export const translations: Record<Language, Record<string, string>> = {
  hu: {
    ...
    "chart.actions.primaryDentition": "Tejfogak (51-85)",
    ...
    "mobility.title": "Mobilitás",
    "periodontal.probingDepth": "Szondázási mélység",
    "periodontal.attachmentLoss": "Tapadásveszteség",
  ...
  en: {
    ...
    "chart.actions.primaryDentition": "Primary teeth (51-85)",
    ...
    "periodontal.probingDepth": "Probing depth",
    "periodontal.attachmentLoss": "Attachment loss",
  ...
  de: {
    ...
    "chart.actions.primaryDentition": "Milchzähne (51-85)",
    ...
    "mobility.title": "Mobilität",
    "periodontal.probingDepth": "Sondierungstiefe",
    "periodontal.attachmentLoss": "Attachmentverlust",
  ...
  es: {
    ...
    "chart.actions.primaryDentition": "Piezas primarias (51-85)",
    ...
    "periodontal.probingDepth": "Profundidad de sondaje",
    "periodontal.attachmentLoss": "Pérdida de inserción",
